const translations = {
  zh: {
    ...
    navWork: "作品",
    navContact: "聯絡",
    heroEyebrow: "台北醫學大學 · 健康科技 / 研究設計",
    heroName: "林以安",
    heroLead: "我把科技、設計與醫療人文連結，打造更溫暖、更有秩序的數位體驗。",
    tag1: "人機互動",
    tag2: "醫療科技",
    tag3: "校園生活",
    tag4: "人文照護",
  ...
  en: {
    ...
    navWork: "Work",
    navContact: "Contact",
    heroEyebrow: "Taipei Medical University · Health Tech / Research Design",
    heroName: "Elian Lin",
    heroLead: "I connect technology, design, and medical humanities to create digital experiences that are warm, thoughtful, and well-structured.",
    tag1: "Human-Computer Interaction",
    tag2: "Health Technology",
    tag3: "Campus Life",
    tag4: "Human Care",
